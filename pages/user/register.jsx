...
const navigationDefault = ["Home", "User", "Sign Up"]
const Register = () => {
    return (
        <div>
            <BreadCrumb title="Sign Up" navigation={navigationDefault} />
            <section className="login section-padding">
                <div className="card">
                    <form>
                        ...
                        <button className="btn w-100 mt-3" type="submit">Sign Up</button>
