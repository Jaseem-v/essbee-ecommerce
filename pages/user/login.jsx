...
const navigationDefault = ["Home", "User", "Login"]
const Login = () => {
    return (
        <div>
            <BreadCrumb title="Login" navigation={navigationDefault} />
            < section className="login section-padding" >
                <div className="card">
                    <form>
                        <h2 className="title"> Log in</h2>
                        <p className="subtitle">Don&apos;t have an account?
                        ...
                        <button className="btn btn--login w-100 mt-3" type="submit">Log In</button>
